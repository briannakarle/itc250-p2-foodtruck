...
{
    echo '
		<h3 class = "center">Aunt Betty sez</h3>
		<h1 class = "center">Thanks for your order!</h1>
        <h3 class = "center"><form action="' . THIS_PAGE . '" method = "post">
        <input type= "submit" name = "reload" value = "Place a New Order" id="reload" />
        </form></h3>
	';
}
...

{
	...
	<tr><td colspan="5"></td><td class="right bottomline"><b>Tax:</b></td><td class="right bottomline">' . money_format('%(#10n', $tax) . '</td></tr>
    	...
    	<tr><td colspan = "5"></td><td  class="right doublebottomline"><b>Total:</b><td class="right doublebottomline"><b>' . money_format('%(#10n', $total) . '</b></td></tr>
';
	...
	<tr><td colspan = "7"><input class="submit" type = "submit" name = "submit" value="' . $re . 'Calculate Price" style = "width:100%" ' . $visableSubmit . ' /></td></td></tr>
	<tr><td colspan = "7"><input class="submit" type = "submit" name = "order" value="Confirm Order" style = "width:100%" ' . $visableConfirm . ' /></td></td></tr>
