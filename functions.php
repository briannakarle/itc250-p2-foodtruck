...
function showForm() {
	...
	echo '<tr>
             <td>
                 <input type="number" name="qty1" min="0" max="99" value="' . $qty1Value .'" />
             </td>
             <td>' . $menuItem[0].Name .'</td>
             <td>'. $menuItemS[0].Description . '"</td>
	      ...
	      <tr>
              <td>
                  <input type="number" name="qty2" min="0" max="99" value="' . $qty2Value .'" />
              </td>
              <td>' . $menuItem[1].Name . '</td>
              <td>'. $menuItemS[1].Description . '"</td>
              <td>' . $menuItemS[1].Price . '</td>
              <td>
                  <input type="checkbox" name="cb21" />Gravy <input type="checkbox" name="cb22" />Jam </td><td>' . $menuTotal1 . '</td><tr>
